...
namespace HotelVp.ServiceControl
{
    ...
    [ToolboxData("<{0}:DropDownTextBox runat=server></{0}:CDropdownList>")]
    public class DropDownTextBox : CompositeControl,IPostBackDataHandler
    {
        TextBox _input;
        ...
        protected override void RenderContents(HtmlTextWriter output)
        {
            ...
            _select.Attributes.Add("onchange", "this.parentNode.nextSibling.value=this.options[this.selectedIndex].text;if (document.getElementById('MainContent_ddtbKeyVal') != null) {document.getElementById('MainContent_ddtbKeyVal').value=this.options[this.selectedIndex].value;}"); 
