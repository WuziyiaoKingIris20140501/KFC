...
public static class PagerControl
{
    public static string Pagers(int cur, string attr, double rowcount, int pageSize, int split = 2)
    {
        ...
        pageBuilder.Append("<div class=\"row-fluid\"><div class=\"span6\"><div class=\"dataTables_info\" id=\"settlelist_info\">");
        ...
        pageBuilder.Append("Showing " + startRow + " to " + endRow + " of " + rowcount + " entries");
        pageBuilder.Append("</div></div><div class=\"span6\"><div class=\"dataTables_paginate paging_bootstrap pagination\"><ul>");
        //var str = new StringBuilder();
        if (cur > 1)
        {
            //str.Append("<a href=\"" + string.Format(attr, cur - 1) + "\" class=\"pg-prev\" >上一页</a>");
            pageBuilder.Append("<li class=\"prev\"><a href=\"#\" onclick=\"" + string.Format(attr, cur - 1) + "\">← Previous </a></li>");
        }
        else
        {
            pageBuilder.Append("<li class=\"prev disabled\"><a href=\"#\"> Previous </a></li>");
        ...
        if (cur < total)
        {
            pageBuilder.Append("<li class=\"next\"><a href=\"#\" onclick=\"" + string.Format(attr, cur - 1) + "\"> Next →</a></li>");
            //str.Append("<a href=\"" + string.Format(attr, cur + 1) + "\" class=\"pg pg_next\" >下一页</a>");
        }
        else
        {
            pageBuilder.Append("<li class=\"next disabled\"><a href=\"#\"> Next </a></li>");
            //str.Append("<span class=\"pg pg_next\">下一页</span>");
        }

        pageBuilder.Append("</ul></div></div></div>");
