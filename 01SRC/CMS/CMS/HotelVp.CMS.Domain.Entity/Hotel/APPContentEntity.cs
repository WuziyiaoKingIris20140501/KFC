...
{
    public class APPContentEntity : BaseEntity
    {
        private List<APPContentDBEntity> appcontentdbentity;
        public List<APPContentDBEntity> APPContentDBEntity
        {
            get { return appcontentdbentity; }
            set { appcontentdbentity = value; }
        }
    }

    public class APPContentDBEntity
    {
        ...
        private string lmbarRoomCode;
        public string LmbarRoomCode
        {
            get { return lmbarRoomCode; }
            set { lmbarRoomCode = value; }
        }

        private string lmbar2RoomCode;
        public string Lmbar2RoomCode
        {
            get { return lmbar2RoomCode; }
            set { lmbar2RoomCode = value; }
        }
