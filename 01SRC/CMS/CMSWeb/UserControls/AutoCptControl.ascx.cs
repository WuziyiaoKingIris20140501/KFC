...
public partial class AutoCptControl : System.Web.UI.UserControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //HiddenParms.Value = CheckName(Request["q"]);
    ...
    private string GetLikeUserName(string valueString)
    {
        ...
        //}
        DataSet dsResult = webBP.GetWebCompleteList(_autoType, valueString, HiddenParms.Value.Trim());
    ...
    public string CTLLEN
    {
        get
        {
            return hiddenCtlLEN.Value;//return _autoResult;
        }
        set
        {
            hiddenCtlLEN.Value = value;//_autoResult = value;
        }
    }
    ...
    public string extraParams
    {
        get
        {
            return HiddenParms.Value;//return _autoResult;
        }
        set
        {
            HiddenParms.Value = value;//_autoResult = value;
        }
    }
