...
public partial class WebUI_Hotel_HotelConsultingRoom : BasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        System.IO.File.WriteAllText("C:\\ConsultLog\\" + UserSession.Current.UserAccount + "-Log.txt",
        ...
        if (!IsPostBack)
        {
            ...
            //设置默认的房控人员
            this.Page.ClientScript.RegisterStartupScript(this.Page.GetType(), "setsalesroomKeys", "SetSalesRoom('[" + UserSession.Current.UserAccount + "]" + UserSession.Current.UserDspName + "');", true);
        }
    }
