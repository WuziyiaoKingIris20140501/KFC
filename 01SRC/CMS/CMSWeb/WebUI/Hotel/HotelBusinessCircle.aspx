<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HotelBusinessCircle.aspx.cs"  Title="酒店商圈管理" Inherits="WebUI_Hotel_HotelBusinessCircle" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function PageClosed() {
            ...
            window.returnValue = document.getElementById("<%=dvUserGroupList.ClientID%>").innerHTML;
            window.opener = null;
            window.close();
        }
    ...
    <div class="frame01">
      <ul>
                        ...
                        <tr>
                            ...
                            <td>
                                <uc1:WebAutoComplete ID="wcthvpTagInfo" runat="server" CTLID="wcthvpTagInfo" AutoType="hvptaginfo"
                                    AutoParent="HotelBusinessCircle.aspx?Type=hvptaginfo" />
                            </td>
                            <td>
        ...
        <li>
            ...
            <ContentTemplate>
            <div id="dvMessageContent" runat="server" style="color:red"></div>
