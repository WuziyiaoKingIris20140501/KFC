<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="onHotel.aspx.cs" Inherits="WebUI_Hotel_onHotel" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
 <div>
    <table align="center" border="0" width="100%" class="Table_BodyCSS">
    <tr class="RowTitle" align="center"><td colspan="4"><asp:Literal Text="设置想上线酒店" ID="lblOnTitle" runat="server"></asp:Literal> </td></tr>           
