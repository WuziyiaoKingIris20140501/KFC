...
public partial class WebUI_Hotel_HotelInfoInlineImage : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            if (Request.Params["HotelInfoManagerByHotelID"] != null && Request.Params["HotelInfoManagerByHotelID"].ToString() != "")
            {
                DataBind(Request.Params["HotelInfoManagerByHotelID"].ToString());
            }
        }
    ...
    public void DataBind(string HotelID)
    {
