...
public partial class ConsultPOrderUserPage : BasePage
{
    ...
    private DataSet BindReviewUserListGrid()
    {
        ...
        DataSet dsResult = UserSearchBP.ReviewConsultPOrderUserSelect(_userEntity).QueryResult;
    ...
    protected void btnOK_Click(object sender, EventArgs e)
    {
        ...
        DataSet dsResult = UserSearchBP.PreConsultPOrderUserSelect(_userEntity).QueryResult;
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        commonDBEntity.Event_Type = "订单审核任务分配-保存";
    ...
    protected void btnRefush_Click(object sender, EventArgs e)
    {
        ...
        _userEntity.UserDBEntity.Add(usergroupEntity);
        DataSet dsResult = UserSearchBP.ReviewConsultPOrderUserDetail(_userEntity).QueryResult;
    ...
    protected void btnDel_Click(object sender, EventArgs e)
    {
        ...
        commonDBEntity.Event_Type = "订单审核任务分配-删除";
        commonDBEntity.Event_ID = hidUserID.Value.ToString().Trim();
    ...
    private DataSet GetYujiDataSource()
    {
        ...
        usergroupEntity.RType = ddpConrultType.SelectedValue.Trim();
        _userEntity.UserDBEntity.Add(usergroupEntity);
        return UserSearchBP.PreConsultPOrderUserSelect(_userEntity).QueryResult;
    }
