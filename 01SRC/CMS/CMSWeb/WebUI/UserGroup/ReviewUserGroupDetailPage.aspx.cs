...
public partial class ReviewUserGroupDetailPage : BasePage
{
    ...
    private void BindViewCSUserGroupListDetail()
    {
        ...
        DataSet dsDetailResult = UserGroupBP.UserDetailListSelect(_userGroupEntity).QueryResult;
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        ...
        dsResult = UserGroupBP.UserDetailListSelect(_userGroupEntity).QueryResult;
