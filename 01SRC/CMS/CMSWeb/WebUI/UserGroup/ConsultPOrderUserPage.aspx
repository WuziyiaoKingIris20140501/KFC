<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master"  CodeFile="ConsultPOrderUserPage.aspx.cs"  Title="订单审核任务分配管理" Inherits="ConsultPOrderUserPage" %>
                ...
                <li>
                    <table>
                        <tr>
                            ...
                            <td align="left">
                                 <uc1:WebAutoComplete ID="wctUser" CTLID="wctUser" runat="server" AutoType="user" AutoParent="ConsultPOrderUserPage.aspx?Type=user" />
                            </td>
                            <td align="left">
                                <asp:UpdatePanel ID="UpdatePanel2" UpdateMode="Conditional" runat="server">
                                    ...
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                    <asp:Button ID="btnAllotAllCitys" runat="server" CssClass="btn primary" OnClientClick="BtnLoadStyle();SetUserHid()" onclick="btnAllotAllCitys_Click" Text="绑定所有城市"/><span style="color:Red">（请先选择用户之后再进行城市绑定！！！）</span>
                                    </ContentTemplate>
                                </asp:UpdatePanel>
                            </td>
                            <td>
                                    ...
                                    <td align="left" id="tdCity" runat="server" style="display:none">
                                        <table>
                                            <tr>
                                                ...
                                                <td>
                                                    <uc1:WebAutoComplete ID="wctCity" runat="server" CTLID="wctCity" AutoType="city" AutoParent="ConsultPOrderUserPage.aspx?Type=city" />
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                    <td align="left" id="tdTag" runat="server" style="display:none">
                                        <table>
                                            <tr>
                                                ...
                                                <td>
                                                    <uc1:WebAutoComplete ID="wctTag" runat="server" CTLID="wctTag" AutoType="tag" AutoParent="ConsultPOrderUserPage.aspx?Type=tag" />
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                    <td align="left" id="tdHotel" runat="server" >
                                        <table>
                                            <tr>
                                                ...
                                                <td>
                                                    <uc1:WebAutoComplete ID="wctHotel" runat="server" CTLID="wctHotel" AutoType="hotel" AutoParent="ConsultPOrderUserPage.aspx?Type=hotel" />
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
