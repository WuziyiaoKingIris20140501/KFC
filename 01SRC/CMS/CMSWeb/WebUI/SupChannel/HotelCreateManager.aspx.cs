...
public partial class HotelCreateManager : BasePage
{
    ...
    public void BindDdpList()
    {
        ...
        if (dsStarRating.Tables.Count > 0)
        {
            ...
            ddpStarRating.SelectedValue = "2|0";
        }
    ...
    protected void txtHotelNM_TextChanged(object sender, EventArgs e)
    {
        ...
        ScriptManager.RegisterStartupScript(this.UpdatePanel5, this.GetType(), "setScript", "SetPYEvent('" + strPinyin + "','" + strShortPinyin + "')", true);
    }
}