<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master"  CodeFile="PushSearchDeatilPage.aspx.cs"  Title="Push消息管理" Inherits="PushSearchDeatilPage" %>
        ...
        <ContentTemplate>
                    ...
                    <li>
                        <table>
                            <tr>
                                ...
                                <td align="left">
                                    <asp:TextBox ID="txtTelPhone" runat="server" Width="200" MaxLength="20" />
                                </td>
                                <td align="left">
            ...
            <div id="messageContent" runat="server" style="color:red"></div>
                <div style="margin-left:10px;"><webdiyer:AspNetPager runat="server" ID="AspNetPager2" CloneFrom="aspnetpager1"></webdiyer:AspNetPager></div>
                    ...
                    <Columns>
                            <asp:BoundField DataField="TelPhone" HeaderText="手机号码" ><ItemStyle HorizontalAlign="Center" Width="20%"/></asp:BoundField>
