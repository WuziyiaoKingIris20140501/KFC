...
public partial class CreateCashBack : BasePage
{
    ...
    protected void btnInSave_Click(object sender, EventArgs e)
    {
        ...
        else if ("2".Equals(hidInCommonType.Value.Trim()) && (String.IsNullOrEmpty(txtInBaoName.Text.Trim())))
        {
            errMsg = GetLocalResourceObject("SaveError8").ToString();
        }
        ...
        cashbackDBEntity.BackBaoName = txtInBaoName.Text.Trim();
