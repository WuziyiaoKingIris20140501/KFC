<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation = "false" MasterPageFile="~/Site.master"  CodeFile="CreateCashBack.aspx.cs"  Title="创建提现申请管理" Inherits="CreateCashBack" %>
		        ...
		        <div>
                    <table>
                            <tr>
                                ...
                                <td align="left">
                                    <input type="button" id="btnCheck" class="btn primary" value="查看已申请提现"  onclick="PopAreaCashDetail();" />
                                </td>
                            </tr>
                            <tr>
                    ...
                    <table>
                            ...
                            <tr>
                                ...
                                <td align="left"><a id="AUserID" href="#" runat="server" style="cursor:pointer;color:Blue" onclick="PopupUserArea('0')"><asp:Label ID="lbUserID" runat="server" Text="" /></a></td>
                                <td align="right">用户可提现余额：</td>
                                <td align="left"><asp:Label ID="lbCanamount" runat="server" Text="" /></td>
                                <td align="right">返现审核中金额：</td>
                                <td align="left"><a id="AAuditamount" href="#" style="cursor:pointer;color:Blue" runat="server" onclick="PopupCashListArea('0','0')"><asp:Label ID="lbAuditamount" runat="server" Text="" /></a></td>
                                <td align="right">提现申请中金额：</td>
                                <td align="left"><a id="APullingamount" href="#" style="cursor:pointer;color:Blue" runat="server" onclick="PopupCashBackListArea('0')"><asp:Label ID="lbPullingamount" runat="server" Text="" /></a></td>
                            </tr>
                            <tr>
                                <td style="height:5px"></td>
                            </tr>
                                    ...
                                    <div id="dvBao" runat="server" style="display:none">
                                        <table>
                                            <tr>
                                                ...
                                                <td align="right"><input type="button" id="btnCopyUserID" class="btn" value="同用户手机号码"  onclick="SetControlEnable('0');" /></td>
                                            </tr>
                                            <tr>
	        ...
	        <div id="tabs-2" style="border: 1px solid #D5D5D5;">
		        <div>
                    ...
                    <table>
                            ...
                            <tr>
                                <td align="right" style="width:100px">用户ID：</td>
                                <td align="left"><a id="AInUserID" href="#" runat="server" style="cursor:pointer;color:Blue" onclick="PopupUserArea('1')"><asp:Label ID="lbInUserID" runat="server" Text="" /></a></td>
                                ...
                                <td align="left"><a id="AInAuditamount" href="#" runat="server" style="cursor:pointer;color:Blue" onclick="PopupCashListArea('0','1')"><asp:Label ID="lbInAuditamount" runat="server" Text="" /></a></td>
                                <td align="right" style="width:120px">提现申请中金额：</td>
                                <td align="left"><a id="AInPullingamount" href="#" runat="server" style="cursor:pointer;color:Blue" onclick="PopupCashBackListArea('1')"><asp:Label ID="lbInPullingamount" runat="server" Text="" /></a></td>
                            </tr>
                            <tr>
                                <td style="height:5px"></td>
                            </tr>
