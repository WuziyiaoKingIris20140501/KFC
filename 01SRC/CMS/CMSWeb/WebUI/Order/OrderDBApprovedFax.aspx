<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="OrderDBApprovedFax.aspx.cs" Inherits="OrderDBApprovedFax" MaintainScrollPositionOnPostback="true" %>
                            ...
                            <tr>
                                <td>
                                    <div class="frame01" style="width: 100%; height: 670px; margin-left: 5px;">
                                        <ul>
                                            <li class="title">复审酒店列表 <span style="float: right;"><span id="countNum" runat="server">0</span></span></li>
                                        </ul>
                                        <ul>
