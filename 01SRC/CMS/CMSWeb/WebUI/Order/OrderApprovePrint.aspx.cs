...
public partial class OrderApprovePrint : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            string outSDate = Request.QueryString["IND"] == null ? "" :  Server.UrlDecode(Request.QueryString["IND"].ToString());
            string outEDate = Request.QueryString["OTD"] == null ? "" :  Server.UrlDecode(Request.QueryString["OTD"].ToString());
            string orderStatus = Request.QueryString["OST"] == null ? "" :  Server.UrlDecode(Request.QueryString["OST"].ToString());
            string orderID = Request.QueryString["OID"] == null ? "" :  Server.UrlDecode(Request.QueryString["OID"].ToString());
            BandData(hotelID, outSDate, outEDate, orderStatus, orderID);
