<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OrderApprovedFaxPrint.aspx.cs" 
    ...
    <table style="width: 650px">
        ...
        <tr style="height: 20px">
            <td align="right" valign="middle" style="font-family: 黑体, monospace; mso-font-charset: 134;
                height: 20px;">
                电话：021-52393373*8021 / 8027<span style='width: 10px'> </span>传真：021-33321996、021-52186011
            </td>
        </tr>
...
<%--        <tr style="height: 3px">
            ...
            <td>
                <table style="width: 100%;margin-top:5px">
                    <tr style="height: 20px; width: 100%;">
                        ...
                        <td align="left" valign="middle" style="font-family: 黑体, monospace; mso-font-charset: 134;
                            height: 20px; width: 35%;">
                            <asp:Label ID="lbTelFrom" runat="server" Text="021-52393373*8021 / 8027" />
                        </td>
                    </tr>
                    <tr style="height: 20px">
                        <td align="right" valign="middle" style="font-family: 黑体, monospace; mso-font-charset: 134;
                        ...
                        <td align="left" valign="middle" style="font-family: 黑体, monospace; mso-font-charset: 134;
                            height: 20px;">
                            <asp:Label ID="lbFaxFrom" runat="server" Text="021-33321996、021-52186011" /></td>
                        <td align="right" valign="middle" style="font-family: 黑体, monospace; mso-font-charset: 134;
                            height: 20px;">
                        </td>
                        <td align="left" valign="middle" style="font-family: 黑体, monospace; mso-font-charset: 134;
        ...
        <tr>
            <td align="left" valign="middle" style="font-family: 黑体, monospace; mso-font-charset: 134;height: 20px;">
            </td>
        </tr>
        <tr style="width:100%">
            <td style="width:100%">
