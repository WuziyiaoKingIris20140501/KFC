<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/Site.master" CodeFile="BatchTicketPackage.aspx.cs"   Culture="zh-cn" UICulture="zh-cn" Title="优惠券礼包管理" Inherits="Ticket_BatchTicketPackage" %>
   ...
   <div id="bgAlertDiv">        
    ...
    <div id="ruleAlertDiv">
        <table style="text-align:center; width:100%">
            <tr class="RowTitle"><td colspan=2><b>新建优惠券礼包返回结果</b></td></tr>
        ...
        <tr>
            ...
            <td class="tdcell">
                <asp:TextBox ID="txtCustomNumber" runat="server" Text="" MaxLength="10" 
                    ontextchanged="txtCustomNumber_TextChanged" AutoPostBack="true" ></asp:TextBox><asp:CheckBox Enabled="false" ID="chkCustomNumber" Text="使用自定义优惠券号码" runat="server" AutoPostBack="true" OnCheckedChanged="ChkCustomValue_Click"/>&nbsp;&nbsp;<asp:Label ID="lbCustomNumMsg" runat="server" Text="" ForeColor="red"/>
            </td>
            <td class="tdcell">
                批量生产礼包数：<asp:TextBox ID="txtBatchPageNumber" runat="server" Text="" MaxLength="10" />
            </td>
            <td>
                绑定规则代码：<asp:TextBox ID="txtRulesCode" runat="server" Text="" MaxLength="20" />
            </td>
        </tr>
        <tr>
            <td class="tdcell"><asp:Label ID="lbl1" runat="server" Text="<%$ Resources:PackageNameLabel %>"/></td>
            <td colspan="3" class="tdcell"><asp:TextBox ID="txtPackageName" runat="server" Width="85%" Height="19px" MaxLength="25"></asp:TextBox><font color="red">*</font></td>
        </tr>
        <tr>
            ...
            <td class="tdcell">
                ...
                <input type="radio" name="RbtPackageType" id="rbtOther" value="2" onclick="SerRbtNameValue('2')"/>其他
                <font color="red">*</font>
      ...
      <tr>
        ...
        <tr><td class="tdcell"><asp:Label ID="Label3" runat="server" Text="<%$ Resources:UsePlatform %>"/></td>
            <td align="left" class="tdcell">
                <asp:ListBox ID="LBUsePlatForm" runat="server" Width="80%" 
        ...
        <tr>
            ...
            <td colspan="3" align="left" class="tdcell">
                <asp:ListBox ID="LBSaleChanel" runat="server" Width="90%" 
                    SelectionMode="Multiple">
           ...
           <%-- </td>
            <td colspan="3" align="left" class="tdcell">--%>
                 <div style="display:none">
                    ...
                    <input id="btnClear" type="button" value="<%=clearLabel %>" class="btn" onclick="Clear()" />
                </div>
           <%-- </td>
        </tr>   --%> 
        <tr>
