...
public partial class HotelSalesDataWeekly : BasePage
{
    ...
    private void BindViewCSReviewGridList()
    {
        ...
        DataSet dsResult = ReportCenterBP.HotelSalesDataReportSelect(_reportCenterEntity).QueryResult;

        gridViewCSReviewList.DataSource = dsResult.Tables[0].DefaultView;
        //gridViewCSReviewList.DataKeyNames = new string[] { "DTID" };//主键
