<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master"  CodeFile="QunaerDataWeekly.aspx.cs"  Title="去哪儿周报查询" Inherits="QunaerDataWeekly" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel3" UpdateMode="Always" runat="server" >
        ...
        <div class="frame02">
                    ...
                    <Columns>
                         ...
                         <asp:BoundField DataField="订单总数" HeaderText="订单总数" ><ItemStyle HorizontalAlign="Center" Width="5%"/></asp:BoundField>
                         <asp:BoundField DataField="成功订单" HeaderText="成功订单" ><ItemStyle HorizontalAlign="Center" Width="5%"/></asp:BoundField>
                         <asp:BoundField DataField="客人取消订单" HeaderText="客人取消订单" ><ItemStyle HorizontalAlign="Center" Width="5%"/></asp:BoundField>
                         <asp:BoundField DataField="cc取消订单" HeaderText="cc取消订单" ><ItemStyle HorizontalAlign="Center" Width="5%"/></asp:BoundField>
                         <asp:BoundField DataField="no-show订单" HeaderText="no-show订单" ><ItemStyle HorizontalAlign="Center" Width="5%"/></asp:BoundField>
                    </Columns>
