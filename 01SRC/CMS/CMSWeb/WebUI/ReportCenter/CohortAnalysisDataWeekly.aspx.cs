...
public partial class CohortAnalysisDataWeekly : BasePage
{
    ...
    private void BindViewCSReviewGridList()
    {
        ...
        DataSet dsResult = ReportCenterBP.CohortAnalysisReportSelect(_reportCenterEntity).QueryResult;

        gridViewCSReviewList.DataSource = dsResult.Tables[0].DefaultView;
        gridViewCSReviewList.DataKeyNames = new string[] { "日期" };//主键
