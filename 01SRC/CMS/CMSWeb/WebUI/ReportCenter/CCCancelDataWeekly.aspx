<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master"  CodeFile="CCCancelDataWeekly.aspx.cs"  Title="客服取消单原因周报查询" Inherits="CCCancelDataWeekly" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel3" UpdateMode="Always" runat="server" >
        ...
        <div class="frame02">
                    ...
                    <Columns>
                         ...
                         <asp:BoundField DataField="订单总量" HeaderText="订单总量" ><ItemStyle HorizontalAlign="Center" Width="5%"/></asp:BoundField>
                         <asp:BoundField DataField="BAR_订单量" HeaderText="BAR_订单量" ><ItemStyle HorizontalAlign="Center" Width="5%"/></asp:BoundField>
                         <asp:BoundField DataField="LM_订单量" HeaderText="LM_订单量" ><ItemStyle HorizontalAlign="Center" Width="5%"/></asp:BoundField>
                         <asp:BoundField DataField="LM订单%" HeaderText="LM订单%" ><ItemStyle HorizontalAlign="Center" Width="5%"/></asp:BoundField>
                         <asp:BoundField DataField="cc取消单" HeaderText="cc取消单" ><ItemStyle HorizontalAlign="Center" Width="5%"/></asp:BoundField>
                         <asp:BoundField DataField="BAR_cc取消单" HeaderText="BAR_cc取消单" ><ItemStyle HorizontalAlign="Center" Width="5%"/></asp:BoundField>
                         <asp:BoundField DataField="BAR_cc取消单%" HeaderText="BAR_cc取消单%" ><ItemStyle HorizontalAlign="Center" Width="5%"/></asp:BoundField>
                         <asp:BoundField DataField="LM_cc取消单" HeaderText="LM_cc取消单" ><ItemStyle HorizontalAlign="Center" Width="5%"/></asp:BoundField>
                         <asp:BoundField DataField="LM_cc取消单%" HeaderText="LM_cc取消单%" ><ItemStyle HorizontalAlign="Center" Width="5%"/></asp:BoundField>
                         <asp:BoundField DataField="BAR取消单占比" HeaderText="BAR取消单占比" ><ItemStyle HorizontalAlign="Center" Width="5%"/></asp:BoundField>
                    </Columns>
