...
public partial class GeneralDataReport : BasePage
{
    ...
    private void BindViewCSReviewGridList()
    {
        ...
        DataSet dsResult = ReportCenterBP.GeneralDataReportSelectList(_reportCenterEntity).QueryResult;

        gridViewCSReviewList.DataSource = dsResult.Tables[0].DefaultView;
        gridViewCSReviewList.DataKeyNames = new string[] { "Month" };//主键
