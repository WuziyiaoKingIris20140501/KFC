...
namespace HotelVp.Common.Logger
{
    ...
    public class CustomLayout : log4net.Layout.LayoutSkeleton
    {
        ...
        static CustomLayout()
        {
            s_globalRulesRegistry = new Hashtable(7);
            s_globalRulesRegistry.Add("literal", typeof(LiteralPatternConverter)); 
            s_globalRulesRegistry.Add("computername", typeof(ComputerNamePatternConverter));
            s_globalRulesRegistry.Add("ipaddress", typeof(IpAddressPatternConverter));
            s_globalRulesRegistry.Add("event_id", typeof(EventIdPatternConverter));
            s_globalRulesRegistry.Add("content", typeof(ContentPatternConverter));
