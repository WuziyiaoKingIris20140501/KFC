...
namespace HotelVp.Common.DataAccess
{
    ...
    public class DynamicQuerySqlBuilder : IDisposable
    {
        ...
        #region These methods have been removed to ConditionConstructor, keep these methods here is only for compatible purpose 

        [Obsolete("This method have been removed to DynamicQuerySqlBuilder.ConditionConstructor")]
        public void AddCondition(
            QueryConditionRelationType conditionRelationType, string fieldName,
            DbType parameterDbType, string parameterName, QueryConditionOperatorType conditionOperatorType, object parameterValue,
            ParameterValueValidateCheckDelegate parameterValueValidateCheckHandler)
        {
            m_conditionConstructor.AddCondition(conditionRelationType, fieldName, parameterDbType,
                parameterName, conditionOperatorType, parameterValue, parameterValueValidateCheckHandler);
        }
        ...
        public void AddBetweenCondition(
            ...
            ParameterValueValidateCheckDelegate parameterValueValidateCheckHandler)
        {
            m_conditionConstructor.AddBetweenCondition(conditionRelationType, fieldName, parameterDbType, parameterName,
                leftConditionOperatorType, rightConditionOperatorType, leftParameterValue, rightParameterValue, parameterValueValidateCheckHandler);
        }
        ...
        public void AddCondition(
            QueryConditionRelationType conditionRelationType,
            string fieldName,DbType parameterDbType,string parameterName,
            QueryConditionOperatorType conditionOperatorType,object parameterValue)
        {
            m_conditionConstructor.AddCondition(conditionRelationType, fieldName, parameterDbType, parameterName,
                conditionOperatorType, parameterValue);
        }
        ...
        {
            m_conditionConstructor.AddNullCheckCondition(conditionRelationType, fieldName, conditionOperatorType);
        }
        ...
        {
            m_conditionConstructor.AddInCondition(conditionRelationType, fieldName, listValueDbType, inValues);
        }
        ...
        public void AddNotInCondition(QueryConditionRelationType conditionRelationType,
            string fieldName, DbType listValueDbType, List<Object> inValues)
        {
            m_conditionConstructor.AddNotInCondition(conditionRelationType, fieldName, listValueDbType, inValues);
        }
        ...
        {
            m_conditionConstructor.AddInCondition<TListValueType>(conditionRelationType, fieldName, listValueDbType, inValues);
        }
        ...
        public void AddNotInCondition<TListValueType>(QueryConditionRelationType conditionRelationType,
            string fieldName, DbType listValueDbType, List<TListValueType> inValues)
        {
            m_conditionConstructor.AddNotInCondition<TListValueType>(conditionRelationType, fieldName, listValueDbType, inValues);
        }

        [Obsolete("This method have been removed to DynamicQuerySqlBuilder.ConditionConstructor")]
        public void BeginGroupCondition(QueryConditionRelationType groupRelationType)
        {
            m_conditionConstructor.BeginGroupCondition(groupRelationType);
        }

        [Obsolete("This method have been removed to DynamicQuerySqlBuilder.ConditionConstructor")]
        public void EndGroupCondition()
        {
            m_conditionConstructor.EndGroupCondition();
        }

        #endregion These methods have been removed to ConditionConstructor, keep these methods here is only for compatible purpose
    ...
    internal abstract class Condition 
    {
        ...
        protected object TryConvertToLikeString(object value)
        {
            ...
            else
            {
                ...
                if (!buildContext.AddedParameterNames.Contains(this.ParameterName))
                {
                    buildContext.DataCommand.AddInputParameter(this.ParameterName, this.ParameterDbType,
                        this.OperatorType == QueryConditionOperatorType.Like ?
                            TryConvertToLikeString(this.ParameterValue) : this.ParameterValue);
