...
//    sessionStorage.setItem(prefix + "deviceID", "")
    ...
    if (arg == "1") {
        ...
        document.getElementById("hidScrollFlag").value = "0";
        ...
        document.getElementById("hidScrollFlag").value = "1";
...
// }
 ...
 function fn_ordercm_index_main_search() {
     Global.LoadProcess();
     $.ajax({
         url: GetPath("/OrderCm/AjxGetIndexMainList"),
         type: "POST",
         dataType: "html",
         data: {
         ...
         success: function (data) {
             ...
             $("#spOCInToday").html(document.getElementById("hidOrderCount").value);
             $("#spOcOffToday").html(document.getElementById("hidOrderCount").value);
             $("#spRCOffToday").html(document.getElementById("hidOdReviewCt").value);
             Global.UnLoadProcess();
         },
         error: function (data) {
             Global.UnLoadProcess();
 ...
 function fn_ordercm_review_main_search() {
     Global.LoadProcess();
     $.ajax({
         url: GetPath("/OrderCm/AjxGetOrderReviewList"),
         type: "POST",
         dataType: "html",
         data: {
             mac: localStorage.getItem("mac"),
 ...
 function fn_ordercm_confirm_orderid_save(opeuserid) {
     ...
     Global.LoadProcess();
     $.ajax({
         url: GetPath("/OrderCm/AjxConfirmOrderInfo"),
         type: "POST",
         async: true,
         dataType: "Json",
         data: {
         ...
         success: function (data) {
             ...
             if (data.message == "success") {
                 ...
                 fn_ordercm_index_refesh_search();
             }
             else {
                 $("#dvProcessbg").hide();
                 $("#ordercmerrmsg").css('display', 'block');
 ...
 function fn_ordercm_index_refesh_search() {
     $.ajax({
         url: GetPath("/OrderCm/AjxGetIndexMainList"),
         type: "POST",
         dataType: "html",
 ...
 function fn_ordercm_list_main_search() {
     Global.LoadProcess();
     $.ajax({
         url: GetPath("/OrderCm/AjxGetOrderQueryInfo"),
         type: "POST",
         async: true,
         dataType: "html",
         data: {
 ...
 function fn_ordercm_list_search() {
     ...
     $.ajax({
         url: GetPath("/OrderCm/AjxGetOrderQueryList"),
         type: "POST",
         async: true,
         dataType: "html",
         data: {
 ...
 function fn_ordercm_prenextmonth(arg) {
     $.ajax({
         url: GetPath("/OrderCm/AjxGetOrderDTPicker"),
         type: "POST",
         async: true,
         dataType: "html",
         data: {
