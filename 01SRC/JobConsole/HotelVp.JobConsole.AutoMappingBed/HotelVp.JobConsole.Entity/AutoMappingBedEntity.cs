...
{
    public class AutoMappingBedEntity : BaseEntity
    {
        private List<AutoHotelComparisonDBEntity> autohotelcomparisondbentity;
        public List<AutoHotelComparisonDBEntity> AutoHotelComparisonDBEntity
        {
            get { return autohotelcomparisondbentity; }
            set { autohotelcomparisondbentity = value; }
        }
    }

    public class AutoHotelComparisonDBEntity
    {
