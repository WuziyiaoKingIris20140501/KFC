...
/// </summary>
    public class JsonRequestURLBuilder
    {
        ...
        {
            string url = lmApiUrlV2 + "/content/hotelDetails.json?useCode=IOS&useCodeVersion=2.0&clientCode=HOTELVP&hotelId={0}&imgSize=100&apiVersion=2.9&inDate={1}&outDate={2}";
