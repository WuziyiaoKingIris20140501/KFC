...
namespace HotelVp.JobConsole.DataAccess
{
    public abstract class PushMsgDA
    {
        ...
        public static DataSet GetPushMsgByFileUpLoad(string taskID)
        {
            ...
            dsResult = HotelVp.Common.DBUtility.DbManager.Query("PushMsg", "t_lm_user_files_list_by_userid", false, lmParm);
            return dsResult;
        }
        ...
        public static int InsertPushPlanActionHistory(string taskID, string userID, string deviceToken, string result)
        {
            DataCommand cmd = DataCommandManager.GetDataCommand("InsertPushInfoPlanActionHistory");
            cmd.SetParameterValue("@TaskID", taskID);
            ...
            {
                DataCommand sucCmd = DataCommandManager.GetDataCommand("UpdatePushInfoPlanSuccCount");
        ...
        public static bool CheckPushPlanActionHistory(string taskID, string UserID)
        {
            DataCommand cmd = DataCommandManager.GetDataCommand("CheckPushInfoPlanActionHistory");
            cmd.SetParameterValue("@TaskID", taskID);
            cmd.SetParameterValue("@UserID", UserID);
