...
public class ToServiceXML
{
    public ToServiceXML()
    {
        ...
        public static string getSendFaxToServerXMLStr()
        {
            string base64 = ToBase64.EncodingForFile("C:\\新建 Microsoft Word 文档.doc");
            string sendFaxXml = "<?xml version=\"1.0\" encoding=\"gb2312\"?>                      " +
                                ...
                                for(int i=8;i<9;i++)
                                {
                                    ...
                                    "<ClientTaskID>"+i+"</ClientTaskID>" +
                                    "<FaxNumber>010-12345678</FaxNumber>" +
                                    "</SendTask>");
                                }
                                sendFaxXml = sendFaxXml + sendTaskStr.ToString() + "</SendTaskList>" +
                                "<DocumentList>                                               " +
                                "     <FileNum>1</FileNum>                                    " +
                                "<Document      FileName=\"uniproud.doc\"                     " +
    ...
    public static string getQueryResultForRecvTaskXMLstr()
    {
        string sendFaxXML = "<?xml version=\"1.0\" encoding=\"gb2312\"?>                         " +
                            ...
                            "   <Password>h1o2t3e4l5v6p7</Password>                                  " +
                            " </Login>                                                       " +
