...
{
    public class AutoMsgUserExcelEntity : BaseEntity
    {
        private List<AutoMsgCancelOrdDBEntity> automsgcancelorddbentity;
        public List<AutoMsgCancelOrdDBEntity> AutoMsgCancelOrdDBEntity
        {
            get { return automsgcancelorddbentity; }
            set { automsgcancelorddbentity = value; }
        }
    }

    public class AutoMsgCancelOrdDBEntity
    {
